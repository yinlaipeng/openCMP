  ...
  <div class="finance-page">
    <el-card>
      ...
      <div class="filter-bar" style="margin-bottom: 16px;">
        ...
        <el-select v-model="selectedSeverity" placeholder="严重程度" clearable style="width: 120px; margin-left: 8px;">
          <el-option label="高" value="high" />
          <el-option label="中" value="medium" />
          <el-option label="低" value="low" />
        </el-select>
        <el-select v-model="selectedStatus" placeholder="状态" clearable style="width: 120px; margin-left: 8px;">
      ...
      <!-- 数据表格 -->
      <el-table :data="anomalies" v-loading="loading" style="width: 100%">
