...
USERNAME = "admin"
PASSWORD = "admin@123"
OUTPUT_DIR = "/Users/aurora/Desktop/xtwork/git/openCMP/scripts/cloudpods_analysis/output"

# 要分析的页面
PAGES_TO_ANALYZE = {
    "lb_instances": "/lb",
    "lb_acls": "/lbacl",
    "lb_certificates": "/lbcert",
    "cdn_domains": "/cdn"
}
...
def main():
    ...
    # 保存汇总结果
    summary_path = os.path.join(OUTPUT_DIR, "all_pages_summary.json")
